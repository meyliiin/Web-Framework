...
<body>
  <div class="container">
    <div class="header">
      <h1>Edit Info Judol</h1>
    </div>

    <div class="form-container">
      <form action="/admin/update/<?= $judol['id']; ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <input type="hidden" name="id" value="<?= $judol['id']; ?>">

        <div class="form-group">
          <label for="judul">Judul</label>
          <input type="text" id="judul" name="judul"
            class="<?= session('errors.judul') ? 'is-invalid' : ''; ?>"
            value="<?= old('judul', $judol['judul']); ?>" placeholder="Masukkan Judul">
        ...
        <div class="form-group">
          ...
          <textarea id="deskripsi" name="deskripsi"
            ...
            placeholder="Tulis deskripsi materi..."><?= old('deskripsi', $judol['deskripsi']); ?></textarea>
          <div class="invalid-feedback">
        ...
        <div class="form-group">
          ...
          <div class="d-flex align-items-center gap-3">
            <img id="preview-img"
              src="/assets/img/<?= $judol['media'] ?: 'default.jpg'; ?>"
